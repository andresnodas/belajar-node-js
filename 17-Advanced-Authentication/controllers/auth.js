...
exports.getReset = (req, res, next) => {
    ...
    res.render('auth/reset', { path: '/reset', pageTitle: 'Reset Password', errorMessage: message.length > 0 ? message[0] : null});
}
...
exports.getNewPassword = (req, res, next) => {
    ...
    .then(user => {
        ...
        res.render('auth/new-password', { path: '/new-password', pageTitle: 'New Password', errorMessage: message.length > 0 ? message[0] : null, userId: user._id.toString(), passwordToken : token});
    })
    .catch(err => console.log(err));
}
